...
order: 1
featuredStat: "75% → 92%"
featuredStatLabel: "Donation fee opt-in, A/B tested"
---
...
<figure class="wide">
  <img class="clear" src="/case-studies/fee-opt-in/05-results.svg" alt="Fee opt-in increased from 75 percent to 92 percent" />

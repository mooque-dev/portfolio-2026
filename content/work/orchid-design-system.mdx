...
Before the pitch, I ran internal surveys across five departments: Engineering, Customer Care, Sales, Marketing, and Product. The goal was to surface recurring pain points that leadership could see in their own teams' words, not just hear from design. Each department had a different relationship to the inconsistency problem — developers were frustrated by unique variants and missing documentation, Customer Care was explaining UI inconsistencies to users daily, Sales was fielding upmarket prospects who compared Keela unfavorably to competitors.

The survey data let me tie the design system investment to three concrete numbers: faster feature delivery, less QA rework, and a coherent experience that would smooth the product merger. It worked. We got two dedicated frontend engineers — the first time a design system had earned that commitment.
...
We adopted Storybook integrated with Chromatic to give the design team a workflow linked to GitHub. Components live in Storybook — not just as documentation, but as the canonical reference for both design and engineering. Chromatic runs visual regression tests on every PR so inconsistencies surface before release, not after.

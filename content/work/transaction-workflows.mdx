...
<figure>
  <img src="/case-studies/transaction-workflows/image-6.jpg" alt="Design review over video call: walking the product and engineering team through the split-transaction flow, with the redesign mockups around it" />
  <figcaption>Design review: walking the team through the split-transaction flow, round by round</figcaption>
</figure>
